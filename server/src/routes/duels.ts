...
import { createHotseat, getMatch, submitScore, getActiveMatch, createInvite, joinByToken } from '../controllers/duel.controller';
...
duelsRouter.post('/invite', validate(createInviteSchema), createInvite);
duelsRouter.post('/join/:token', joinByToken);
